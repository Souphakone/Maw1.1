...
<div class="row">
        ...
        <table class="records">
            ...
            <tbody>
                <tr>
                    ...
                    <td>single_line</td>
                    <td>
                        <a title="Edit" href="index.php?controller=exercise&action=edit">
    ...
    <section class="column">
        <h1>New Field</h1>
        <form action="index.php?controller=exercise&action=fields" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="h7qdtoWh6/AXCQQfdaupw16QwDJ3SJyW0wQvI7Z6D10LM/l3xR0ke0ZFn8Nes0+LR7onELPPR0XAs7z5kX4M8Q==" />
